        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if (UserManager.IsInRole(user.Id, "Admin") && (model.IsAdmin))
                    {
                        return RedirectToAction("Index", "Admin");
                    }
                    else if ((UserManager.IsInRole(user.Id, "Student")) && !(model.IsAdmin))
                    {
                    ...
                    else
                    {
                        ...
                        return RedirectToAction("Login", "Account", new { modelState = "Invalid login attempt." });
                    }
